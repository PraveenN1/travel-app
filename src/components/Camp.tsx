...
const HorizontalScroll: React.FC = () => {
    ...
    return (
        <div className={styles.scrollContainer}>
            <button className={`${styles.scrollButton} ${styles.left}`} onClick={scrollLeftClick}>
                &#9664;
            </button>
            <div
            ...
            >
                <div className={styles.card}>
                  <div className={styles.overlay}>
                        <div className={styles.text}>Text on Image 1</div>
                    </div>
                  <Image
                    src="/img-1.png"
                    alt="cardimg"
            ...
            <button className={`${styles.scrollButton} ${styles.right}`} onClick={scrollRightClick}>
                &#9654;
            </button>
        </div>
    );
